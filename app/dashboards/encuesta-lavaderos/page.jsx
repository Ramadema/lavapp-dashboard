...
const seccion = buscarSeccion("encuesta-lavaderos");
...
export default function Dashboard() {
  ...
  if (error)
    return (
      <>
        <EncabezadoSeccion titulo={seccion.titulo} subtitulo={seccion.subtitulo} />
        <main className="contenedor">
          <div className="panel error">
            <strong>No se pudo conectar con la API.</strong>
            <br />
            No se pudieron cargar las respuestas de la encuesta. Probá recargar
            la página.
          </div>
        </main>
      </>
  ...
  if (!respuestas)
    return (
      <>
        <EncabezadoSeccion titulo={seccion.titulo} subtitulo={seccion.subtitulo} />
        <main className="contenedor">
          <div className="panel cargando">Cargando encuesta…</div>
        </main>
      </>
    );
  ...
  return (
    <>
      <EncabezadoSeccion
        ...
        subtitulo="Indicadores de la encuesta sobre gestión operativa de lavaderos de autos. Los KPIs se recalculan al filtrar por método de registro actual."
        senal={{ tono: "ok", texto: `n = ${respuestas.length}` }}
      />
